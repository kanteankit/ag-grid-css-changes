                            ...
                            >
                              ...
                              >
                                ...
                                <v-toolbar
                                  dense
                                  flat
                                  class="pa-0 toolbarStyling flex-grow-0 mb-3"
                                >
                                  <v-spacer></v-spacer>
                                  <span
                                    v-if="lastUpdateTime"
...
:deep(.tox.tox-tinymce.tox-tinymce--toolbar-sticky-off) {
  ...
  height: 100% !important; /* First 48px for bottom tabs bar. Next 48px for the editors toolbar that has the Save button */
  overflow-y: visible;
}
</style>
